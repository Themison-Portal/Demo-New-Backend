...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000003', 'Themison Demo Org', '11111111-1111-1111-1111-111111111111', true)
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000002', 'Demo', 'User', 'demo@themison.com')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000001', 'Demo User', 'demo@themison.com',
   '00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000002', 'admin', true)
ON CONFLICT (id) DO NOTHING;
